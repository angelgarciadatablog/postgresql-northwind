-- =============================================================================
--  Northwind para PostgreSQL
--  https://github.com/angelgarciadatablog/postgresql-northwind
--
--  Base de datos de ejemplo de Microsoft (licencia MIT), adaptada a PostgreSQL
--  para aprender y ensenar SQL relacional.
--
--  ATENCION: este script BORRA y RECREA todo. Es el boton de reset.
--  Si rompiste la base practicando, vuelve a ejecutarlo y queda como nueva.
--
--  Uso:  psql -d northwind -f seed.sql
-- =============================================================================

BEGIN;

-- -----------------------------------------------------------------------------
-- 1. Limpieza. CASCADE arrastra las claves foraneas que apunten a estas tablas.
-- -----------------------------------------------------------------------------
...
-- Regiones comerciales (Este, Oeste, Norte, Sur)
CREATE TABLE region (
...
-- Territorios de venta. Cada uno pertenece a una region.
...
-- Categorias de producto (Bebidas, Condimentos, Lacteos, ...)
...
-- Empleados. reports_to apunta a esta misma tabla: es la jerarquia (self-join).
CREATE TABLE employees (
    ...
    CONSTRAINT chk_emp_fechas CHECK (birth_date < hire_date)
);

-- Empleado <-> territorio. Muchos a muchos: PK compuesta por las dos FK.
...
-- Clientes. La PK es un codigo de 5 letras ('ALFKI'), no un numero.
...
CREATE TABLE products (
    ...
    CONSTRAINT chk_prod_stock CHECK (units_in_stock >= 0)
);

-- Pedidos. shipped_date admite NULL: son los pedidos aun no despachados.
CREATE TABLE orders (
    ...
    CONSTRAINT chk_ord_freight  CHECK (freight >= 0),
    CONSTRAINT chk_ord_required CHECK (required_date >= order_date),
    CONSTRAINT chk_ord_shipped  CHECK (shipped_date IS NULL OR shipped_date >= order_date)
);

-- Detalle de pedido. El corazon del modelo: muchos a muchos entre pedidos
-- y productos, con las medidas (cantidad, precio, descuento) en la relacion.
...
-- Estados de EE.UU. Tabla de consulta: se une por customers.region = state_abbr.
...
-- -----------------------------------------------------------------------------
-- 3. Indices sobre las claves foraneas mas consultadas
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 4. Datos
--    El orden importa: primero las tablas a las que otras apuntan.
-- -----------------------------------------------------------------------------
...
INSERT INTO products VALUES
	(1, 'Chai', 8, 1, '10 boxes x 30 bags', 18.00, 39, 0, 10, true),
	(2, 'Chang', 1, 1, '24 - 12 oz bottles', 19.00, 17, 40, 25, true),
	...
	(15, 'Genen Shouyu', 6, 2, '24 - 250 ml bottles', 13.00, 39, 0, 5, false),
	...
	(61, 'Sirop d''érable', 29, 2, '24 - 500 ml bottles', 28.50, 113, 0, 25, false),
...
INSERT INTO orders VALUES
	...
	(10444, 'BERGS', 3, '1997-02-12', '1997-03-12', '1997-02-21', 3, 3.50, 'Berglunds snabbköp', 'Berguvsvägen  8', 'Luleå', NULL, 'S-958 22', 'Sweden'),
	(10445, 'BERGS', 3, '1997-02-13', '1997-03-13', '1997-02-20', 1, 9.30, 'Berglunds snabbköp', 'Berguvsvägen  8', 'Luleå', NULL, 'S-958 22', 'Sweden'),
...
INSERT INTO orders VALUES
	...
	(10449, 'BLONP', 3, '1997-02-18', '1997-03-18', '1997-02-27', 2, 53.30, 'Blondel père et fils', '24, place Kléber', 'Strasbourg', NULL, '67000', 'France'),
	...
	(10527, 'QUICK', 7, '1997-05-05', '1997-06-02', '1997-05-07', 1, 41.90, 'QUICK-Stop', 'Taucherstraße 10', 'Cunewalde', NULL, '01307', 'Germany'),
	...
	(10556, 'SIMOB', 2, '1997-06-03', '1997-07-15', '1997-06-13', 1, 9.80, 'Simons bistro', 'Vinbæltet 34', 'Kobenhavn', NULL, '1734', 'Denmark'),
	...
	(10566, 'BLONP', 9, '1997-06-12', '1997-07-10', '1997-06-18', 1, 88.40, 'Blondel père et fils', '24, place Kléber', 'Strasbourg', NULL, '67000', 'France'),
...
INSERT INTO orders VALUES
	...
	(10703, 'FOLKO', 6, '1997-10-14', '1997-11-11', '1997-10-20', 2, 152.30, 'Folk och fä HB', 'Åkergatan 24', 'Bräcke', NULL, 'S-844 67', 'Sweden'),
	...
	(10774, 'FOLKO', 4, '1997-12-11', '1997-12-25', '1997-12-12', 1, 48.20, 'Folk och fä HB', 'Åkergatan 24', 'Bräcke', NULL, 'S-844 67', 'Sweden'),
	...
	(10788, 'QUICK', 1, '1997-12-22', '1998-01-19', '1998-01-19', 2, 42.70, 'QUICK-Stop', 'Taucherstraße 10', 'Cunewalde', NULL, '01307', 'Germany'),
	(10789, 'FOLIG', 1, '1997-12-22', '1998-01-19', '1997-12-31', 2, 100.60, 'Folies gourmandes', '184, chaussée de Tournai', 'Lille', NULL, '59000', 'France'),
	...
	(10841, 'SUPRD', 5, '1998-01-20', '1998-02-17', '1998-01-29', 2, 424.30, 'Suprêmes délices', 'Boulevard Tirou, 255', 'Charleroi', NULL, 'B-6000', 'Belgium'),
...
INSERT INTO orders VALUES
	...
	(10859, 'FRANK', 1, '1998-01-29', '1998-02-26', '1998-02-02', 2, 76.10, 'Frankenversand', 'Berliner Platz 43', 'München', NULL, '80805', 'Germany'),
	...
	(10931, 'RICSU', 4, '1998-03-06', '1998-03-20', '1998-03-19', 2, 13.60, 'Richter Supermarkt', 'Starenweg 5', 'Genève', NULL, '1204', 'Switzerland'),
	...
	(10946, 'VAFFE', 1, '1998-03-12', '1998-04-09', '1998-03-19', 2, 27.20, 'Vaffeljernet', 'Smagsloget 45', 'Århus', NULL, '8200', 'Denmark'),
	...
	(10977, 'FOLKO', 8, '1998-03-26', '1998-04-23', '1998-04-10', 3, 208.50, 'Folk och fä HB', 'Åkergatan 24', 'Bräcke', NULL, 'S-844 67', 'Sweden'),
	...
	(10995, 'PERIC', 1, '1998-04-02', '1998-04-30', '1998-04-06', 3, 46.00, 'Pericles Comidas clásicas', 'Calle Dr. Jorge Cash 321', 'México D.F.', NULL, '05033', 'Mexico'),
	...
	(11001, 'FOLKO', 2, '1998-04-06', '1998-05-04', '1998-04-14', 2, 197.30, 'Folk och fä HB', 'Åkergatan 24', 'Bräcke', NULL, 'S-844 67', 'Sweden'),
	...
	(11020, 'OTTIK', 2, '1998-04-14', '1998-05-12', '1998-04-16', 2, 43.30, 'Ottilies Käseladen', 'Mehrheimerstr. 369', 'Köln', NULL, '50739', 'Germany'),
	...
	(11037, 'GODOS', 7, '1998-04-21', '1998-05-19', '1998-04-27', 1, 3.20, 'Godos Cocina Típica', 'C/ Romero, 33', 'Sevilla', NULL, '41101', 'Spain'),
	...
	(11043, 'SPECD', 5, '1998-04-22', '1998-05-20', '1998-04-29', 2, 8.80, 'Spécialités du monde', '25, rue Lauriston', 'Paris', NULL, '75016', 'France'),
...
INSERT INTO orders VALUES
	...
	(11059, 'RICAR', 2, '1998-04-29', '1998-06-10', NULL, 2, 85.80, 'Ricardo Adocicados', 'Av. Copacabana, 267', 'Rio de Janeiro', 'RJ', '02389-890', 'Brazil'),
	...
	(11070, 'LEHMS', 2, '1998-05-05', '1998-06-02', NULL, 1, 136.00, 'Lehmanns Marktstand', 'Magazinweg 7', 'Frankfurt a.M.', NULL, '60528', 'Germany'),
...
-- -----------------------------------------------------------------------------
-- 5. Secuencias
--    Los datos traen ids explicitos, asi que hay que adelantar cada secuencia
--    al maximo usado. Sin esto, el primer INSERT de un alumno chocaria con
--    un id que ya existe. Es el error clasico al migrar datos con ids fijos.
-- -----------------------------------------------------------------------------
SELECT setval(pg_get_serial_sequence('region',     'region_id'),   (SELECT max(region_id)   FROM region));
...
SELECT setval(pg_get_serial_sequence('shippers',   'shipper_id'),  (SELECT max(shipper_id)  FROM shippers));
...
SELECT setval(pg_get_serial_sequence('us_states',  'state_id'),    (SELECT max(state_id)    FROM us_states));
...
-- 6. Verificacion
-- -----------------------------------------------------------------------------
SELECT 'region'               AS tabla, count(*) AS filas, 4    AS esperado FROM region
UNION ALL SELECT 'territories',          count(*), 53   FROM territories
UNION ALL SELECT 'categories',           count(*), 8    FROM categories
UNION ALL SELECT 'suppliers',            count(*), 29   FROM suppliers
UNION ALL SELECT 'shippers',             count(*), 6    FROM shippers
UNION ALL SELECT 'employees',            count(*), 9    FROM employees
UNION ALL SELECT 'employee_territories', count(*), 49   FROM employee_territories
UNION ALL SELECT 'customers',            count(*), 91   FROM customers
UNION ALL SELECT 'products',             count(*), 77   FROM products
UNION ALL SELECT 'orders',               count(*), 830  FROM orders
UNION ALL SELECT 'order_details',        count(*), 2155 FROM order_details
UNION ALL SELECT 'us_states',            count(*), 51   FROM us_states;
